...
class protoParser ( Parser ):
    ...
    class ByeExprContext(ExprContext):
        ...
        def BYE(self):
            return self.getToken(protoParser.BYE, 0)
    ...
    class HelloExprContext(ExprContext):
        ...
        def HELLO(self):
            return self.getToken(protoParser.HELLO, 0)
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [9]:
                localctx = protoParser.NumberExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx

                self.state = 3
                localctx.atom = self.match(protoParser.INT)
                pass
            elif token in [5]:
                localctx = protoParser.ParenExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 4
                self.match(protoParser.T__4)
                self.state = 5
                self.expr(0)
                self.state = 6
                self.match(protoParser.T__5)
                pass
            elif token in [7]:
                localctx = protoParser.HelloExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 8
                localctx.atom = self.match(protoParser.HELLO)
                pass
            elif token in [8]:
                localctx = protoParser.ByeExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 9
                localctx.atom = self.match(protoParser.BYE)
                pass
            else:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = protoParser.InfixExprContext(self, protoParser.ExprContext(self, _parentctx, _parentState))
